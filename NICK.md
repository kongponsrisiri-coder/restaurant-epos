...
| **Start Up Loan (British Business Bank)** | ✅ **£15,000 approved in TWO TRANCHES @ 7.5% / 60 months** — arranged via **BizBritain (Karl)**, funded by **GC Business Finance** (FCA regulated · 0161 245 4977 · bfsul@growthco.uk). **Tranche A = £10,000 (DRAWN) → repayment ≈ £200/month.** **Tranche B = £5,000 — APPROVED, agreement SIGNED and funds RELEASED 23 Sep 2026** (lands within 5 working days, i.e. by Wed 30 Sep). Once its schedule starts, total repayments ≈ **£300/mo** (£5k at 7.5% over 60 months ≈ £100/mo on top of Tranche A); the first payment date is in the GC self-service account. Ring-fence it for stock that turns into cash (printer top-up, till buffer), not overheads. ⚠️ **PERSONAL liability of the director, not the company's.** Do not recommend applying for a new Start Up Loan — this facility already exists. |
