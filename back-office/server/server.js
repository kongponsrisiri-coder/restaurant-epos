...
const loyaltyRoutes  = require('./routes/loyalty'); // SEPOS-LOYALTY-001 — 🎁 Loyalty card (proxies the loyalty service)
...
app.use('/api/loyalty', loyaltyRoutes);  // SEPOS-LOYALTY-001
