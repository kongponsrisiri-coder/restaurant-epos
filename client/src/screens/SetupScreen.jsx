    ...
    <div style={{ minHeight: '100dvh', background: NAVY, display: 'flex', flexDirection: 'column',
      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        {/* SEPOS-VERSION-001 — was the literal string "v1.4.5" while the build was
            1.75, on BOTH apps. version.js existed and claimed to be shown here but
            was imported nowhere, so every version read off a setup-screen photo was
            wrong. Render the real constant; bump it with build.gradle versionName. */}
