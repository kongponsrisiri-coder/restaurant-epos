                    ...
                    {isEditing ? (
                      <div style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 80px 80px 90px 90px', gap: 8 }}>
                          ...
                          <div><label style={{ fontSize: 11, fontWeight: 700, color: '#888', display: 'block', marginBottom: 3 }}>Qty</label><input type="text" inputMode="decimal" step="0.001" value={item.quantity} onChange={e => updateLine(i, 'quantity', e.target.value)} style={inStyle} /></div>
                          ...
                          <div><label style={{ fontSize: 11, fontWeight: 700, color: '#888', display: 'block', marginBottom: 3 }}>Unit Price £</label><input type="text" inputMode="decimal" step="0.01" value={item.unit_price} onChange={e => updateLine(i, 'unit_price', e.target.value)} style={inStyle} /></div>
                          <div><label style={{ fontSize: 11, fontWeight: 700, color: '#888', display: 'block', marginBottom: 3 }}>Line Total £</label><input type="text" inputMode="decimal" step="0.01" value={item.line_total} onChange={e => updateLine(i, 'line_total', e.target.value)} style={inStyle} /></div>
                        </div>
