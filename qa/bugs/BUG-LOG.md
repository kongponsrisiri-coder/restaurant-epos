...
| BUG-EPOS-007 | Customer "Anything we should know?" note (allergy info) never shows on Kitchen SCREEN — print-only; invisible on KDS/Direct-Mode setups | Restaurant EPOS | High | 🔧 Fixed by Nook — amber note strip added to `KitchenScreen.jsx`, awaiting Korakot review + deploy | Nook → Krit verify | 2026-06-07 |
